...
//    public String getRequestUrl2(boolean useBranh) {
//        String url;
//        if (useBranh){
//            url = getBaseUrl();
//        } else {
//            url = getBaseUrl() + getBranchUrl();
//        }
//
//        RequestParams urlParams = new RequestParams();
//        onGetUrlParams(urlParams);
...
//            }
    ...
    public Map<String, String> onCreateHeader(Map<String, String> header) {
        //TODO: change your token here
        String token = "ya29.a0AfH6SMB8ISRuOrT8wv44TqIYRRNRj6Zl5OVBnoqe59Sgh-PByjyD815Jvk1jbIcrjXMmFftXOBC7IKVetdfcyKFQYe5RFk8splc05nkm7zG84MoWpc_pb47ipb03zXaK9vAbVBo5L2mKuViyfzm_KG05hB9e";
